...
<div class="row">
        <div class="col-md-6 col-lg-6">
            ...
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form class="role" method="POST" action="{{route('user.update',$user->id)}}">
                        @method('PATCH')
                            {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group has-feedback {{$errors->has('name') ? 'has-error':''}}">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Usuário" value="{{old('name',$user->name)}}"> @if($errors->has('name'))
                        ...
                        <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group has-feedback {{$errors->has('email') ? 'has-error':''}}">
                                        ...
                                        <input type="text" id="email" class="form-control" name="email" placeholder="Email do usuário" value="{{old('email',$user->email)}}"> @if($errors->has('email'))
                                        <span class="help-block">
