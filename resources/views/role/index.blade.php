...
<div class="row">
    <div class="col-xs-12 col-md-12">
        ...
        <p>
            <a class="btn btn-success btn-lg" href="{{route('role.create')}}">Cadastrar</a>
        </p>
        <div class="box">
                ...
                <table class="table table-hover table-bordered" id="tablerole">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$role->label}}</td>
                                <td>
                                    <a href="{{route('role.edit',$role->id)}}" class="btn btn-xs btn-primary" title="Editar Paciente"><i class="glyphicon glyphicon-edit"></i></a>
