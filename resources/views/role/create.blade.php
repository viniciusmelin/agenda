                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group has-feedback {{$errors->has('name') ? 'has-error':''}}">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Nome do Perfil" value="{{old('name')}}"> @if($errors->has('name'))
                        ...
                        <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group has-feedback {{$errors->has('label') ? 'has-error':''}}">
                                        ...
                                        <input type="text" id="label" class="form-control" name="label" placeholder="Descrição do Perfil" value="{{old('label')}}"> @if($errors->has('label'))
                                        <span class="help-block">
