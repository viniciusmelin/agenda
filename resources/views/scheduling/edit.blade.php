...
<div class="row">
        <div class="col-md-10 col-lg-10">
            ...
            <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form class="role" method="POST" action="{{route('scheduling.update',$scheduling->id)}}">
                            @method('PATCH')
                            {{ csrf_field() }}
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <div class="input-group has-feedback {{$errors->has('name') ? 'has-error':''}}">
                                        <input type="text" class="form-control" placeholder="Pesquisar Médico" id="nameDoctor" value="{{old('name',$scheduling->doctor->name)}}" disabled>
                            ...
                            <input type="hidden" id="doctor_id" name="doctor_id" value="{{$scheduling->doctor->id}}">
                            <input type="hidden" id="patient_id" name="patient_id" value="{{$scheduling->patient->id}}">
                            <div class="col-lg-5">
                                    <label for="name">Paciente</label>
                                <div class="input-group has-feedback {{$errors->has('name') ? 'has-error':''}}">
                                        <input type="text" class="form-control" placeholder="Pesquisar Paciente" id="namePatient" value="{{old('name',$scheduling->patient->name)}}" readonly>
                        ...
                        <div class="col-lg-3">
                                <div class="form-group has-feedback {{$errors->has('date') ? 'has-error':''}}">
                                    ...
                                    <input type="date" id="date" class="form-control" name="date" value="{{old('date',$scheduling->date)}}"> @if($errors->has('date'))
                                    <span class="help-block">
